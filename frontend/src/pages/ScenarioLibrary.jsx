...
const MODAL_SUBTITLE = `Sample preview: ${SLICE4_PREVIEW_DEFAULTS.total_rounds} months × ${SLICE4_PREVIEW_DEFAULTS.round_duration_days} days with ${SLICE4_PREVIEW_DEFAULTS.historical_leadin_days}-day historical lead-in. Amber = history students see; sky = full fiscal year demand.`;
    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Compare demand patterns before you build a fiscal year. Each card shows a sample timeline —
